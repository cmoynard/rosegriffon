...
const socialLinks = [
  ...
  {
    name: "Instagram",
    url: "https://www.instagram.com/rose_griffonfr",
    icon: () => (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    color: "text-white hover:text-white bg-[#E1306C] hover:bg-[#E1306C]",
  },
];
                      ...
                      <CollapsibleContent>
                        <SidebarMenuSub>
                          {item.items?.map((subItem) => (
                            <SidebarMenuSubButton asChild key={subItem.title}>
                              <Link
                                href={subItem.url || "/"}
                                className="text-white hover:text-black [&:hover>svg]:stroke-black"
                              >
                                <subItem.icon color="white" />
