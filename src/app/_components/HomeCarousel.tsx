      ...
      >
        <CarouselContent className="h-full">
          {carouselCards
            ...
            .map((card) => (
              <CarouselItem key={card.index} className="h-full pt-0">
                          ...
                          <div className="absolute inset-0 w-full h-full">
                            <Image
                              ...
                              alt={
                                ...
                                `Slide ${card.index + 1} Rose Griffon`
                              }
                              fill
...
export default React.memo(HomeCarousel, (prevProps, nextProps) => {
  // Comparer les données pour éviter les re-rendus inutiles
  ...
  return prevProps.data.every((item, index) => {
    ...
    return (
      ...
      item.metadata.title === nextItem.metadata.title &&
      item.metadata.href === nextItem.metadata.href &&
      item.metadata.newTab === nextItem.metadata.newTab
    );
  });
});
