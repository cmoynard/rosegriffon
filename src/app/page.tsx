...
import BanniereTiktok from "@public/tiktokbanner.png";
      ...
      <div className="flex flex-col gap-8 px-4 mt-8">
        ...
        <FusionBlock
          ...
          imageOverlay={
            <div className="absolute inset-0 flex items-center justify-center">
              <svg
                className="w-16 h-16 lg:w-24 lg:h-24 text-black bg-white rounded-full p-2 shadow-2xl shadow-black"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
        ...
        <FusionBlock isImageLeft={false} image={BanniereAchillea.src}>
          <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mt-6">
              ...
              <a
                href="https://discord.gg/4hYBura5VG"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.twitch.tv/achillea_ie"
                target="_blank"
                rel="noopener noreferrer"
