...
export default function CollaborateursPage() {
  return (
    <main className="container mx-auto py-4 px-4">
      <Suspense fallback={<PartenairesSectionSkeleton />}>
        <PartenairesSection />
      </Suspense>
    </main>
  );
...
function PartenairesSectionSkeleton() {
  return (
    <section className="flex flex-col gap-8">
      <div className="space-y-4">
        <Skeleton className="h-12 w-64 bg-gray-400" />
        <Skeleton className="h-20 max-w-3xl bg-gray-400" />
      </div>
